...
# ✅ Safe title & icon (Windows-friendly)
st.set_page_config(page_title="Groq Chat - Streaming", page_icon=":speech_balloon:", layout="wide")
...
with st.sidebar:
    ...
    api_key = st.text_input(
        ...
        type="password",
        value=default_key,
        help="Paste your Groq API key or set env var GROQ_API_KEY"
    )
...
if user_input:
    ...
    if system_prompt.strip():
        # Always keep system prompt at the top
